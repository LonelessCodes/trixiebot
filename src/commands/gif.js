...
module.exports = function install(cr) {
    ...
    const gifCommand = cr
        .registerCommand("gif", new TreeCommand())
        .setHelp(
            new HelpContent()
    ...
    gifCommand
        ...
        .setHelp(new HelpContent().setUsage("<query>", "returns a random gif for the given `query`"));
    ...
    gifCommand
        ...
        .setHelp(new HelpContent().setUsage("", "returns a random trending gif"));

    gifCommand.registerDefaultCommand(new OverloadCommand()).registerOverload(
        "1+",
        new SimpleCommand(async ({ message, content }) => {
