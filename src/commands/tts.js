            ...
            new SimpleCommand(async ({ message, content, ctx }) => {
                if (!/[a-z0-9]/.test(content)) {
                    ...
                    return new Translation(
                        "tts.invalid_msg",
                        "Ehhh rather send a normal message. This kind of message is know to kinda break me"
                    );
                }
                ...
                if (content.length > 90000) {
                    ...
                    return new Translation(
                        "tts.too_long",
                        "I'm sorry to disappoint you, but I may only use up to 100000 character :/"
                    );
                }
                ...
                try {
                    ...
                    if (!request.ok) throw new AudioConnectError("HTTP Request Error");
