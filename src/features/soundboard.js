...
const soundboard = require("../logic/managers/SoundboardManager");
const SampleID = require("../logic/managers/soundboard/SampleID");
const SampleList = require("../logic/managers/soundboard/SampleList");
