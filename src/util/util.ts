...
export function findDefaultChannel(guild: Discord.Guild): Discord.TextChannel | undefined {
    return (guild.channels.cache.find(c => new RegExp("general", "g").test(c.name) && c.type === "text") ||
        guild.channels.cache
            ...
            .find(c => !!guild.me && !!c.permissionsFor(guild.me)?.has("SEND_MESSAGES"))) as Discord.TextChannel | undefined;
}
